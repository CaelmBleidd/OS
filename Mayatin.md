...
* дырки (file-holes). Такой файл фактически является буфером куда-то. Т.е. это не файл в типичном его понимании. Они тоже разделяются на блочные и байт-
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwODE3OTMxMTgsNTMwNjM3Nzg5LDE2NT
