...
* дырки (file-holes). Такой файл фактически является буфером куда-то. Т.е. это не файл в типичном его понимании. Они тоже разделяются на блочные и байт-ориентированные. 

Какие типовые файлы можно встретиться? 
...
* /dev/sdb5
Донор
`dd if=/dev/sda | nc -|p|12345`
Получатель 
`nc 192.168.0.1:12345 | dd of=/dev/sda

<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI4ODczNjk5Nyw1MzA2Mzc3ODksMTY1Nj
