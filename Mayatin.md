...
Ещё одна проблема здесь -- вопрос, связанный с сетевой маршруторизацией. Наружу я смотрю одним IP адресом, хотя внутри существует множество адресов (вида 192.168.0.*). Это значит, что для каждого пакета нужно будет принимать решение о его перенаправлении, это долго. Решение получило название **Native virtualization**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MjI4NDc4MDIsNTMwNjM3Nzg5LDE2NT
