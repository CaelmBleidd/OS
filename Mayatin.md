...
В windows всё устроено по другому. Он использует "государственную модель". Есть диспетчер процессов, который управляет абсолютно всеми процессами. Когда процесс хочет создать
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzU4NzY3MjU5LDkwNDUzODYwOCwxNTk2Mz
